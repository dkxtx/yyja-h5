...
export default {
  ...
  methods: {
    getBanner () {
      axios
        .get('https://wa.cihangca.com:20010/wawy/user/banner')
        .then(res => {
    ...
    getCategory () {
      axios
        .get('https://wa.cihangca.com:20010/wawy/user/categories')
        .then(res => {
    ...
    getStore () {
      axios
        .get('https://wa.cihangca.com:20010/wawy/user/recommend/stores')
        .then(res => {
    ...
    getGood () {
      axios
        .get('https://wa.cihangca.com:20010/wawy/user/hot/goods')
        .then(res => {
          console.log(res)
