<template>
  <div class="container">
    ...
    <div class="address-item">
      <div class="address" >{{selected_address.provinceName+selected_address.cityName+selected_address.countyName}}</div>
      <div class="address-detail">{{selected_address.detailInfo}}</div>
      <div class="user">{{selected_address.userName}}
        <span style="margin-left:10rpx">{{selected_address.telNumber }}</span>
      </div>
    </div>
    <div class="line"></div>
    <div class="section">
      <div style="width:10rpx;height:40rpx;background:#D5B388;margin-top:30rpx;margin-right:20rpx"></div>订单信息</div>
    <div class="item">
      <div class="item-left">
    ...
    <div class="footer">
      <div class="footer-price">
        <div class="total-price">合计：<span style="color:#FD6842">￥{{totalAmount}}</span>
        </div>
